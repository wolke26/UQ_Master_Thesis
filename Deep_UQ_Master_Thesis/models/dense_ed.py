...
class DenseED(nn.Module):
    def __init__(self, in_channels, out_channels, blocks, growth_rate=16,
        ...
        last_trans_up = last_decoding(num_features, out_channels, 
                            ...
                            output_padding=0, bias=False, drop_rate=drop_rate)
...
if __name__ == '__main__':
    ...
    dense_ed = DenseED(1, 1, blocks=(2, 5, 2), growth_rate=18, 
                      init_features=20, drop_rate=0, bn_size=2, 
                      bottleneck=True, out_activation='Tanh')
    print(dense_ed)
    x = torch.Tensor(18, 1, 20,20)
